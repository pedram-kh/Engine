/**
 * `useTheme` — main SPA composable that exposes the active Vuetify theme
 * and a typed `setTheme` action. This module is the SINGLE source of
 * truth for theme management in the main SPA: components MUST consume
 ...
 *   `src/plugins/vuetify.ts` until `setTheme` is called.
 *
 ...
 *   `apps/admin/src/composables/useTheme.ts`. Surface parity is asserted
