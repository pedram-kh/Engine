 ...
 * owns the brand mark, the locale switcher, and a slot for the page
 * content. Mirror of `apps/main/src/modules/auth/layouts/AuthLayout.vue`
 * (chunk 6.6) verbatim, with admin's `app.title` rendered in the brand mark.
 *
