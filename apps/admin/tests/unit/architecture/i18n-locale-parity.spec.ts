 ...
 *
 * `i18n-auth-codes.spec.ts` pins backend-code coverage for the `auth` bundle;
 * this complements it with a full-tree parity contract across the whole
 * `locales/` directory, adding gates a coverage check can't catch:
 *
